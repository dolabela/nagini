...
def direct_accuracy_score(y_true, y_pred):
...
def direct_precision_score(y_true, y_pred):
...
def direct_recall_score(y_true, y_pred):
...
def direct_f1_score(y_true, y_pred):
    ...
    """
    recall = direct_recall_score(y_true, y_pred)
    precision = direct_precision_score(y_true, y_pred)
